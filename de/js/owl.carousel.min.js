...
!function(a, b, c, d) {
	...
	e.Defaults= {
		...
		responsive: {}
		,
		responsiveRefreshRate: 200, responsiveBaseElement:b, fallbackEasing:"swing", info:!1, nestedItemSelector:!1, itemElement:"div", stageElement:"div", refreshClass:"owl-refresh", loadedClass:"owl-loaded", loadingClass:"owl-loading", rtlClass:"owl-rtl", responsiveClass:"owl-responsive", dragClass:"owl-drag", itemClass:"owl-item", stageClass:"owl-stage", stageOuterClass:"owl-stage-outer", grabClass:"owl-grab"
	}
	,
	e.Width= {
	...
	e.prototype.initialize=function() {
		if(this.enter("initializing"), this.trigger("initialize"), this.$element.toggleClass(this.settings.rtlClass, this.settings.rtl), this.settings.autoWidth&&!this.is("pre-loading")) {
			...
			c=this.settings.nestedItemSelector?"."+this.settings.nestedItemSelector: d, e=this.$element.children(c).width(), b.length&&e<=0&&this.preloadAutoWidthImages(b)
		}
	...
	e.prototype.maximum=function(a) {
		...
		if(e.loop)f=this._clones.length/2+this._items.length-1;
			...
			for(b=this._items.length, c=this._items[--b].width(), d=this.$element.width();
...
function(a, b, c, d) {
	...
	;
	e.Defaults= {
		autoplay: true, autoplayTimeout:13e3, autoplayHoverPause:!1, autoplaySpeed:!1
	}
	,
